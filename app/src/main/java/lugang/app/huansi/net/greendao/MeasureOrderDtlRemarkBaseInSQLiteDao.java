...
/** 
 * DAO for table "MEASURE_ORDER_DTL_REMARK_BASE_IN_SQLITE".
*/
public class MeasureOrderDtlRemarkBaseInSQLiteDao extends AbstractDao<MeasureOrderDtlRemarkBaseInSQLite, Long> {

    public static final String TABLENAME = "MEASURE_ORDER_DTL_REMARK_BASE_IN_SQLITE";

    /**
     * Properties of entity MeasureOrderDtlRemarkBaseInSQLite.<br/>
    ...
    */
    ...
    public MeasureOrderDtlRemarkBaseInSQLiteDao(DaoConfig config) {
        super(config);
    }
    
    public MeasureOrderDtlRemarkBaseInSQLiteDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MEASURE_ORDER_DTL_REMARK_BASE_IN_SQLITE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MEASURE_ORDER_DTL_REMARK_BASE_IN_SQLITE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MeasureOrderDtlRemarkBaseInSQLite entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MeasureOrderDtlRemarkBaseInSQLite entity) {
        stmt.clearBindings();
    ...
    @Override
    public MeasureOrderDtlRemarkBaseInSQLite readEntity(Cursor cursor, int offset) {
        MeasureOrderDtlRemarkBaseInSQLite entity = new MeasureOrderDtlRemarkBaseInSQLite( //
    ...
    @Override
    public void readEntity(Cursor cursor, MeasureOrderDtlRemarkBaseInSQLite entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MeasureOrderDtlRemarkBaseInSQLite entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MeasureOrderDtlRemarkBaseInSQLite entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
