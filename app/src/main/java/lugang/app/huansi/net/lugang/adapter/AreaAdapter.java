...
public class AreaAdapter extends HsBaseAdapter<NewMeasureBean> {

    public AreaAdapter(List<NewMeasureBean> list, Context context) {
        super(list, context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvElementString.setText(newMeasureBean.SAREANAME);
        return convertView;
    }
}
