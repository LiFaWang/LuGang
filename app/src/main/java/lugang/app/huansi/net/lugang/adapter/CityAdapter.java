...
public class CityAdapter extends HsBaseAdapter<NewMeasureBean> {
    public CityAdapter(List<NewMeasureBean> list, Context context) {
        super(list, context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvElementString.setText(newMeasureBean.SCITYNAME);
        return convertView;
    }
}
