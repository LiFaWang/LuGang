...
public class CountyAdapter extends HsBaseAdapter<NewMeasureBean> {
    public CountyAdapter(List<NewMeasureBean> list, Context context) {
        super(list, context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvElementString.setText(newMeasureBean.SCOUNTYNAME);
        return convertView;
    }
}
