...
public class DepartmentAdapter extends HsBaseAdapter<NewMeasureBean> {
    public DepartmentAdapter(List<NewMeasureBean> list, Context context) {
        super(list, context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvElementString.setText(newMeasureBean.SDEPARTMENTNAME);
        return convertView;
    }
}
