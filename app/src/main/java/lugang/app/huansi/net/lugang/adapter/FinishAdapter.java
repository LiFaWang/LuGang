...
public class FinishAdapter extends HsBaseAdapter<MeasureOrderInSQLite> {

    public FinishAdapter(List<MeasureOrderInSQLite> list, Context context) {
        super(list, context);
    }

    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView==null)convertView = View.inflate(mContext, R.layout.finish_measure_item, null);
